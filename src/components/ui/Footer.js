...
export default function Footer() {
  ...
  const footerLinkStyles = "text-[11px] uppercase tracking-widest text-zinc-500 hover:text-white transition-colors duration-300 block";
  const sectionTitleStyles = "text-[10px] uppercase tracking-[0.3em] font-black text-white mb-8";
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="border-t border-white/5 mt-20 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            <Link href="#" className="text-[9px] font-mono text-zinc-600 hover:text-white uppercase tracking-widest transition">Instagram</Link>
            <Link href="#" className="text-[9px] font-mono text-zinc-600 hover:text-white uppercase tracking-widest transition">Twitter</Link>
            <Link href="#" className="text-[9px] font-mono text-zinc-600 hover:text-white uppercase tracking-widest transition">Legal</Link>
          </div>
        </div>
      </div>
    </footer>
